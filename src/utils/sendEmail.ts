...
async function sendMailOtp(
  ...
  try {
    ...
    console.error(`Error al enviar email con enlace de pago para matrícula ${matricula}:`, error);
    throw error;
  }
}
...
async function sendPaymentConfirmationEmail(
  ...
  try {
    ...
    console.error(`Error al enviar email de confirmación de pago para matrícula ${matricula}:`, error);
    throw error;
  }
}
